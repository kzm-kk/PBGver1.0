    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int Lv = Integer.parseInt(((SpannableStringBuilder) et[2].getText()).toString());
                ...
                i.putExtra("Lv", Lv);
                i.putExtra("HP", Double.parseDouble(((SpannableStringBuilder) et[3].getText()).toString()));
                i.putExtra("MP", Double.parseDouble(((SpannableStringBuilder) et[4].getText()).toString()));
                i.putExtra("ATK", Double.parseDouble(((SpannableStringBuilder) et[5].getText()).toString()));
                i.putExtra("MTK", Double.parseDouble(((SpannableStringBuilder) et[6].getText()).toString()));
                i.putExtra("DEF", Double.parseDouble(((SpannableStringBuilder) et[7].getText()).toString()));
                i.putExtra("MEF", Double.parseDouble(((SpannableStringBuilder) et[8].getText()).toString()));
                i.putExtra("SPD", Double.parseDouble(((SpannableStringBuilder) et[9].getText()).toString()));
                i.putExtra("ACC", Double.parseDouble(((SpannableStringBuilder) et[10].getText()).toString()));
                i.putExtra("EVA", Double.parseDouble(((SpannableStringBuilder) et[11].getText()).toString()));
                i.putExtra("specialty", specialtyset());
                i.putExtra("resist",resistset());
                i.putExtra("explimit",(int)(27 * Math.pow(expmul,Lv - 1)));
